...
package com.pesawise.spring.boot.minio;
...
public class MinioConfiguration {
    ...
    @Bean
    public MinioClient minioClient() throws InvalidEndpointException, InvalidPortException, IOException, InvalidKeyException, NoSuchAlgorithmException, InsufficientDataException, InternalException, InvalidBucketNameException, XmlPullParserException, ErrorResponseException, InvalidResponseException, com.pesawise.spring.boot.minio.MinioException, XmlParserException {
                ...
                if (!b) {
                    if (minioConfigurationProperties.isCreateBucket()) {
                        try {
                            ...
                            throw new com.pesawise.spring.boot.minio.MinioException("Cannot create bucket", e);
                        }
                    } else {
